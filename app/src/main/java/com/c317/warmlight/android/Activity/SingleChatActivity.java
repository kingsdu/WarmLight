...
public class SingleChatActivity extends Activity implements View.OnClickListener {
    ...
    @Bind(R.id.iv_singlechat_me)
    ImageView ivSinglechatMe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivSinglechatMe.setVisibility(View.VISIBLE);

        account = UserManage.getInstance().getUserInfo(SingleChatActivity.this).account;
//        group_id=mGroup_id;
        ivBackMe.setOnClickListener(this);
        ivSinglechatMe.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button_sendchat:
                ...
                findViewById(R.id.emojibox).setVisibility(View.GONE);
                break;
            case R.id.iv_singlechat_me:
                Intent intent = new Intent(SingleChatActivity.this, SingleChatSettingAty.class);
    ...
    private void sendWords() {
        if (TextUtils.isEmpty(etSendwords.getText())) {
            Toast.makeText(SingleChatActivity.this, "请输入聊天内容",
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                ...
                if (resultInfo.code == 201) {
                    ...
                    Toast.makeText(SingleChatActivity.this, "请求成功", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(SingleChatActivity.this, resultInfo.desc, Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onError(Throwable ex, boolean isOnCallback) {
//                Toast.makeText(SingleChatActivity.this, "请求失败", Toast.LENGTH_SHORT).show();
            }
...
//
    ...
    private void loadChats() {
        // 加载已读信息
        dataBaseHelper = WarmLightDataBaseHelper.getDatebaseHelper(SingleChatActivity.this);
...
//            if (convertView == null) {
            if (chat.getIsme() == 1) {
                convertView = View.inflate(SingleChatActivity.this, R.layout.chat_item_right, null);
            } else {
                convertView = View.inflate(SingleChatActivity.this, R.layout.chat_item, null);
            }
...
//            holder.tvAccount.setText(chat.getUserName());
            ...
            Picasso.with(SingleChatActivity.this).invalidate(uri);
            Picasso.with(SingleChatActivity.this).load(uri).networkPolicy(NetworkPolicy.NO_CACHE).into(holder.ivpic);
            return convertView;
        }
